...
-- ============================================================
CREATE DATABASE IF NOT EXISTS montagens_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE montagens_db;
CREATE TABLE IF NOT EXISTS montagens (
  id INT AUTO_INCREMENT PRIMARY KEY,
  visitante VARCHAR(100) NOT NULL,
  -- nome/identificação do visitante
  configuracao JSON NOT NULL,
  -- dados da montagem enviados pelo cliente
  status ENUM('na_fila', 'em_execucao', 'concluida', 'erro') NOT NULL DEFAULT 'na_fila',
